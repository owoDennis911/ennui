...
import me.earth.earthhack.impl.modules.dev.speedmine.mode.ESPMode;
...
public class Speedmine extends Module {
    ...
    public final Setting<Color> start_color =
            register(new ColorSetting("Start Colour", new Color(255, 0, 0)))
                    .setComplexity(Complexity.Medium);
    public final Setting<Color> end_color =
            register(new ColorSetting("End Colour", new Color(0, 255, 0)))
                    .setComplexity(Complexity.Medium);
    ...
    public void abortCurrentPos() {
        ...
        mc.world.sendBlockBreakProgress(Globals.mc.player.getEntityId(), pos, -1);
