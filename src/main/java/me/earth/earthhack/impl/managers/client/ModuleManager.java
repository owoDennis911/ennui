...
import me.earth.earthhack.impl.modules.client.altsync.AltSync;
...
import me.earth.earthhack.impl.modules.client.translator.Translator;
...
import me.earth.earthhack.impl.modules.movement.headhitter.HeadHitter;
import me.earth.earthhack.impl.modules.movement.nobedstep.NoBedStep;
import me.earth.earthhack.impl.modules.movement.airjump.AirJump;
import me.earth.earthhack.impl.modules.misc.alerts.Alerts;
import me.earth.earthhack.impl.modules.misc.autoez.AutoEZ;
import me.earth.earthhack.impl.modules.combat.autopot.AutoPot;
import me.earth.earthhack.impl.modules.movement.autowalk.AutoWalk;
import me.earth.earthhack.impl.modules.movement.cornerclip.Clip;
import me.earth.earthhack.impl.modules.combat.pearlphase.PearlPhase;
import me.earth.earthhack.impl.modules.misc.suffix.Suffix;
...
import me.earth.earthhack.impl.modules.combat.autoregear.AutoRegear;
...
import me.earth.earthhack.impl.modules.dev.speedmine.Speedmine;
...
public class ModuleManager extends IterationRegister<Module>
{
    public void init()
    {
        ...
        this.forceRegister(new Translator());
        ...
        this.forceRegister(new HeadHitter());
        ...
        this.forceRegister(new Alerts());
        this.forceRegister(new Clip());
        this.forceRegister(new Suffix());

        this.forceRegister(new NoBedStep());


        // Dev category
        this.forceRegister(new AutoPot());
        ...
        this.forceRegister(new PistonPush());
