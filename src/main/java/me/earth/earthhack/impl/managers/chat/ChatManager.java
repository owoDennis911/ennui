...
public class ChatManager extends SubscriberImpl implements Globals {
    ...
    public void sendPrefixScheduled(String message,
                                    String uniqueWord,
                                    int senderID) {
        Integer id = message_ids
                .computeIfAbsent(senderID, v -> new ConcurrentHashMap<>())
        ...
        mc.addScheduledTask(() -> ChatUtil.sendMessage(ChatFormatting.LIGHT_PURPLE + "[" + ChatFormatting.DARK_PURPLE + "Ennui" + ChatFormatting.LIGHT_PURPLE + "] " + ChatFormatting.RESET + message, id));
    }
    ...
    public void sendDeleteMessage(String message,
        ...
        ChatUtil.sendMessage( ChatFormatting.LIGHT_PURPLE + "[" + ChatFormatting.DARK_PURPLE + "Ennui" + ChatFormatting.LIGHT_PURPLE + "] " + ChatFormatting.RESET + message, id);
    }

    public void sendPMessage(String message) {
        ChatUtil.sendMessage(ChatFormatting.LIGHT_PURPLE + "[" + ChatFormatting.DARK_PURPLE + "Ennui" + ChatFormatting.LIGHT_PURPLE + "] " + ChatFormatting.RESET + message);
    }
